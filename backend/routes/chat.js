...
const CATEGORY_MAP = [
  ...
  { keys: ["завет", "zavet"], category: "zavet", label: "🏘️ Завет", shortLabel: "Завет" },
  { keys: ["исперих", "isperih"], category: "isperih", label: "🏘️ Исперих", shortLabel: "Исперих" },
  { keys: ["кубрат", "kubrat"], category: "kubrat", label: "🏘️ Кубрат", shortLabel: "Кубрат" },
  { keys: ["лозница", "loznitsa"], category: "loznitsa", label: "🏘️ Лозница", shortLabel: "Лозница" },
  { keys: ["самуил", "samuil"], category: "samuil", label: "🏘️ Самуил", shortLabel: "Самуил" },
  { keys: ["цар калоян", "car kaloqn", "tsar kaloyan", "car kaloyan", "tsar kaloqn"], category: "tsar-kaloyan", label: "🏘️ Цар Калоян", shortLabel: "Цар Калоян" },
