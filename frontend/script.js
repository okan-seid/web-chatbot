...
window.addEventListener("load", () => {
  if (chatBox.children.length === 0) {
    addMessage(
      ...
      "<em>Нови/Последни/Актуални</em><br/>" +
      "<em>Разград/Предстоящо/Криминални/Инциденти</em><br/>" +
      "<em>Спорт/Областта/България/Свят</em><br/>" +
      "<em>Любопитно/Подкасти/Гласът на Разград</em><br/>" +
